  ...
  <div class="container">
    <div class="breadcrumbs">
        <ol class="breadcrumb">
          ...
          <li class="active">Detail Kategori <?php echo $jenis->jenis_nama ?></li>
        </ol>
      </div>
    <div class="row">
        <div class="col-sm-3">
     ...
     <div class="col-sm-9 padding-right">
                <div class="features_items">
                    <h2 class="title text-center">Kategori <?php echo $jenis->jenis_nama ?></h2> 
                     <?php
                     error_reporting(0);
                     $where_jenis['k.jenis_id'] = $jenis_id;
              $where            = (empty($jenis_id))?'': $where_jenis;
                                    $jml_data = $this->ADM->count_all_kasur();
                                    if ($jml_data > 0) {
                                        foreach ($this->ADM->grid_all_kasur('*', 'kasur_waktu', 'DESC', $batas, $page, $where , '') as $row){
                                        ?>
                    <div class="col-sm-4">
